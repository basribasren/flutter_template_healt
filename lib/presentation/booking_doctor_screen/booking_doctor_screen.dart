...
import 'package:basri_s_application16/widgets/custom_icon_button.dart';
...
class BookingDoctorScreen extends StatelessWidget {
  ...
  Widget _buildReason1(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      _buildCard(context,
          actionName: "lbl_reason".tr, actionLabel: "lbl_change".tr),
      SizedBox(height: 7.v),
  ...
  Widget _buildPaymentMethod(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      _buildCard(context,
          actionName: "lbl_visa".tr, actionLabel: "lbl_change".tr)
    ]);
  }
